...
local HttpError = require(script.HttpError)

local PackagesDir = if script.Parent:FindFirstChild("Packages") then script.Parent.Packages else script.Parent
local Promise = require(PackagesDir.Promise)
